          ...
          actions: [
            ...
            IconButton(
              icon: Icon(Icons.grid_on_outlined,
                  color: provider.showGrid ? Colors.white : Colors.white60, size: 20),
              tooltip: 'Toggle Grid',
            ...
            IconButton(
              icon: Icon(Icons.undo_rounded,
                  color: provider.canUndo ? Colors.white : Colors.white38, size: 20),
              tooltip: 'Undo  Ctrl+Z',
            ...
            IconButton(
              icon: Icon(Icons.redo_rounded,
                  color: provider.canRedo ? Colors.white : Colors.white38, size: 20),
              tooltip: 'Redo  Ctrl+Y',
            ...
            Padding(
              ...
              child: TextButton.icon(
                onPressed: () => showCodeExport(context),
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: Row(
            children: [
              // Left: Widget palette (vertical icons like screenshot)
...
// ── Vertical Palette (like screenshot left sidebar) ───────────
class _VerticalPalette extends StatelessWidget {
            ...
            child: Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text('More', style: TextStyle(fontSize: 8, color: ForgeTheme.primary, fontWeight: FontWeight.w600)),
                ],
              ),
            ),
          ),
  ...
  static final _quickWidgets = [
    (Icons.text_fields_rounded, 'TEXT', WType.text),
    (Icons.image_outlined, 'IMAGE', WType.image),
    (Icons.add_box_outlined, 'ICON', WType.icon),
    (Icons.smart_button_outlined, 'BUTTON', WType.button),
    (Icons.format_list_bulleted, 'LIST VIEW', WType.listView),
    (Icons.crop_square_rounded, 'CONTAINER', WType.container),
  ];
            ...
            child: Column(
              children: [
                Container(
                  ...
                  width: 36, height: 4,
                  decoration: BoxDecoration(color: ForgeTheme.border, borderRadius: BorderRadius.circular(2)),
                ),
                const Padding(
                  padding: EdgeInsets.fromLTRB(16, 0, 16, 8),
                  child: Text('All Widgets', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
                ),
...
class _PaletteIconBtn extends StatelessWidget {
  ...
  const _PaletteIconBtn({required this.icon, required this.label, required this.onTap});
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(label, style: const TextStyle(fontSize: 8, color: ForgeTheme.textMuted, fontWeight: FontWeight.w600, letterSpacing: 0.3)),
          ],
        ),
      ),
    );
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: Border(top: BorderSide(
              color: isActive ? ForgeTheme.primary : Colors.transparent, width: 2)),
          ),
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(icon, size: 20, color: isActive ? ForgeTheme.primary : ForgeTheme.textMuted),
              const SizedBox(height: 2),
              Text(label, style: TextStyle(
                color: isActive ? ForgeTheme.primary : ForgeTheme.textMuted,
                fontSize: 10, fontWeight: isActive ? FontWeight.w700 : FontWeight.normal)),
            ],
          ),
        ),
      ),
